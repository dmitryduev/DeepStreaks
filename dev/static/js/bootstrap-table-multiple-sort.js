...
(function($) {
    ...
    var showSortModal = function(that) {
        ...
        if (!$(_id).hasClass("modal")) {
            ...
            sModal += '         <div class="modal-dialog" role="document">';
            sModal += '             <div class="modal-content">';
            sModal += '                 <div class="modal-header">';
            sModal += '                     <h5 class="modal-title" id="' + _selector + 'Label">' + that.options.formatMultipleSort() + '</h5>';
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        if (this.options.showMultiSort) {
            ...
            if (!$multiSortBtn.length && this.options.showMultiSortButton) {
                $multiSortBtn = '<div class="multi-sort btn-group">';
                $multiSortBtn += '<button class="btn btn-secondary' + (this.options.iconSize === undefined ? '' : ' btn-' + this.options.iconSize) + '" type="button" data-toggle="modal" data-target="' + sortModalId + '" title="' + this.options.formatMultipleSort() + '">';
